...
const signup = () => {
    return (
        <div className="flex justify-center items-center flex-col min-h-screen bg-gray-100 dark:bg-neutral-800 dark:border-neutral-700 text-gray-800 dark:text-gray-200 transition-all duration-300">

            <div className="flex justify-center items-center mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
                <div className="p-4 sm:p-7">
                    ...
                    <div className="mt-5 min-w-min w-sm max-w-md">
